...
During the presentation something stood out as a big red flag: a severe lack of a killer app*****.***** The Vision can make a really big screen, the spatial stuff is great, and the hand gesturing interactions are really cool. But the suite of apps that come with VisionOS are ports of what’s already on our phones, tablets, and laptops, albeit optimised for the VisionOS. But, where’s THE app that’s going to make us rush out and buy this thing? What’s it able to do that we aren’t already doing? Where’s its VisiCalc? 
