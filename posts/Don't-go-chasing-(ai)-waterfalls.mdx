...
- One big thing we’re already seeing is the ability for unstructured data, like an email or conversation, to be converted to a structured format suitable for an API. Scenarios where documents or voice conversations need to be parsed, interpreted and actioned will be ripe for further reducing friction.
