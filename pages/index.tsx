  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Great software starts with great design."
          key="description"
        />
      ...
      <HeroBanner
        ...
        headline="Hatch Head is a design agency specialising in making softare products and apps amazing user experiences."
